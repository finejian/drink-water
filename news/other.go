...
const (
	// https://juejin.cn/tag/%E9%9D%A2%E8%AF%95?sort=newest
	otherURL = `https://api.juejin.cn/recommend_api/v1/article/recommend_tag_feed`
)
...
func OnceOther(offset int) (article *Article, err error) {
	param, _ := json.Marshal(map[string]interface{}{
		"id_type":   2,
		"sort_type": 300,
		"cursor":    "0",
		"tag_ids":   []string{"6809640404791590919"},
	})
	resp, err := httplib.Post(otherURL).
