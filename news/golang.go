...
const (
	// https://juejin.cn/tag/Go?sort=newest
	golangURL = `https://api.juejin.cn/recommend_api/v1/article/recommend_tag_feed`
)
...
func OnceGolang(offset int) (article *Article, err error) {
	param, _ := json.Marshal(map[string]interface{}{
		"id_type":   2,
		"sort_type": 300,
		"cursor":    "0",
		"tag_ids":   []string{"6809640364677267469"},
	})
